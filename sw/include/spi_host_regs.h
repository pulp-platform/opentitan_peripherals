...
// Configuration options register.
#define SPI_HOST_CONFIGOPTS_2_REG_OFFSET 0x20
#define SPI_HOST_CONFIGOPTS_2_CLKDIV_2_MASK 0xffff
#define SPI_HOST_CONFIGOPTS_2_CLKDIV_2_OFFSET 0
#define SPI_HOST_CONFIGOPTS_2_CLKDIV_2_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_2_CLKDIV_2_MASK, .index = SPI_HOST_CONFIGOPTS_2_CLKDIV_2_OFFSET })
#define SPI_HOST_CONFIGOPTS_2_CSNIDLE_2_MASK 0xf
#define SPI_HOST_CONFIGOPTS_2_CSNIDLE_2_OFFSET 16
#define SPI_HOST_CONFIGOPTS_2_CSNIDLE_2_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_2_CSNIDLE_2_MASK, .index = SPI_HOST_CONFIGOPTS_2_CSNIDLE_2_OFFSET })
#define SPI_HOST_CONFIGOPTS_2_CSNTRAIL_2_MASK 0xf
#define SPI_HOST_CONFIGOPTS_2_CSNTRAIL_2_OFFSET 20
#define SPI_HOST_CONFIGOPTS_2_CSNTRAIL_2_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_2_CSNTRAIL_2_MASK, .index = SPI_HOST_CONFIGOPTS_2_CSNTRAIL_2_OFFSET })
#define SPI_HOST_CONFIGOPTS_2_CSNLEAD_2_MASK 0xf
#define SPI_HOST_CONFIGOPTS_2_CSNLEAD_2_OFFSET 24
#define SPI_HOST_CONFIGOPTS_2_CSNLEAD_2_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_2_CSNLEAD_2_MASK, .index = SPI_HOST_CONFIGOPTS_2_CSNLEAD_2_OFFSET })
#define SPI_HOST_CONFIGOPTS_2_FULLCYC_2_BIT 29
#define SPI_HOST_CONFIGOPTS_2_CPHA_2_BIT 30
#define SPI_HOST_CONFIGOPTS_2_CPOL_2_BIT 31

// Chip-Select ID
#define SPI_HOST_CSID_REG_OFFSET 0x24

// Command Register
#define SPI_HOST_COMMAND_REG_OFFSET 0x28
...
#define SPI_HOST_ERROR_ENABLE_REG_OFFSET 0x34
...
#define SPI_HOST_ERROR_STATUS_REG_OFFSET 0x38
...
#define SPI_HOST_EVENT_ENABLE_REG_OFFSET 0x3c
